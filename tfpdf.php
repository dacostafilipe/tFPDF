...
class tFPDF
{
    ...
    function ImageCropped($file, $x = null, $y = null, $w = 0, $h = 0, $type = '', $link = '')
    {

        list($width, $height, $typenumb, $attr) = getimagesize($file);
        ...
        if (in_array($type, ['jpg', 'jpeg', 'png'])) {
            ...
            if ($crop_ratio > $ratio) {
                ...
                $newHeight = $width / $crop_ratio;

                $thumb = imagecreatetruecolor($width, $newHeight);

                $dst_y = 0 - ($height - $newHeight) / 2;
                ...
                $tmpfile = tempnam(sys_get_temp_dir(), 'pdfImage' . md5($file));

                if ($type == 'png') {
                    imagepng($thumb, $tmpfile);
                } else {
                    imagejpeg($thumb, $tmpfile, 90);
                }

                $this->Image($tmpfile, $x, $y, $w, $h, $type, $link);
